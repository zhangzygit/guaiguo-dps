...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2020-03-30")
public class PersonService {
    ...
    public interface AsyncIface {
        ...
        public void getPerson(PersonType type, AsyncMethodCallback resultHandler) throws TException;
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void send_getPerson(PersonType type) throws TException {
            getPerson_args args = new getPerson_args();
            args.setType(type);
            sendBase("getPerson", args);
        }

        public Person recv_getPerson() throws TException {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public void getPerson(PersonType type, AsyncMethodCallback resultHandler) throws TException {
            checkReady();
            getPerson_call method_call = new getPerson_call(type, resultHandler, this, ___protocolFactory, ___transport);
        ...
        public static class getPerson_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            public getPerson_call(PersonType type, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
        ...
        public static class getPerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPerson_args> {
            ...
            public getPerson_result getResult(I iface, getPerson_args args) throws TException {
                getPerson_result result = new getPerson_result();
                result.success = iface.getPerson(args.type);
                return result;
            }
        }
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public static class getPerson<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPerson_args, Person> {
            ...
            public void start(I iface, getPerson_args args, AsyncMethodCallback<Person> resultHandler) throws TException {
                iface.getPerson(args.type, resultHandler);
            }
        }
    ...
    public static class getPerson_args implements org.apache.thrift.TBase<getPerson_args, getPerson_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPerson_args> {
         ...
         * @see PersonType
         */
        public PersonType type; // required
        ...
        static {
            ...
            tmpMap.put(_Fields.TYPE, new org.apache.thrift.meta_data.FieldMetaData("type", org.apache.thrift.TFieldRequirementType.DEFAULT,
                    new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, PersonType.class)));
         ...
         * @see PersonType
         */
        public getPerson_args setType(PersonType type) {
            this.type = type;
            return this;
        }
        ...
        private static class getPerson_argsStandardScheme extends StandardScheme<getPerson_args> {
            ...
            public void read(org.apache.thrift.protocol.TProtocol iprot, getPerson_args struct) throws TException {
                    ...
                    switch (schemeField.id) {
                        case 1: // TYPE
                            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                                struct.type = PersonType.findByValue(iprot.readI32());
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, getPerson_args struct) throws TException {
                struct.validate();
        ...
        private static class getPerson_argsTupleScheme extends TupleScheme<getPerson_args> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, getPerson_args struct) throws TException {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, getPerson_args struct) throws TException {
    ...
    public static class getPerson_result implements org.apache.thrift.TBase<getPerson_result, getPerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPerson_result> {
        ...
        private static class getPerson_resultStandardScheme extends StandardScheme<getPerson_result> {
            ...
            public void read(org.apache.thrift.protocol.TProtocol iprot, getPerson_result struct) throws TException {
                org.apache.thrift.protocol.TField schemeField;
                iprot.readStructBegin();
                while (true) {
                    schemeField = iprot.readFieldBegin();
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, getPerson_result struct) throws TException {
                struct.validate();
        ...
        private static class getPerson_resultTupleScheme extends TupleScheme<getPerson_result> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, getPerson_result struct) throws TException {
                TTupleProtocol oprot = (TTupleProtocol) prot;
                BitSet optionals = new BitSet();
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, getPerson_result struct) throws TException {
                TTupleProtocol iprot = (TTupleProtocol) prot;
                BitSet incoming = iprot.readBitSet(1);
                if (incoming.get(0)) {
                    struct.success = new Person();
